...
var ScopeSet_ScopeSet = /** @class */ (function () {
    function ScopeSet() {
    }
    /**
...
var UrlUtils_UrlUtils = /** @class */ (function () {
    ...
    UrlUtils.createNavigationUrlString = function (serverRequestParams) {
        var scopes = ScopeSet_ScopeSet.appendDefaultScopes(serverRequestParams.scopes);
        var str = [];
        str.push("response_type=" + serverRequestParams.responseType);
        str.push("scope=" + encodeURIComponent(ScopeSet_ScopeSet.parseScope(scopes)));
...
var ServerRequestParameters_ServerRequestParameters = /** @class */ (function () {
    ...
    function ServerRequestParameters(authority, clientId, responseType, redirectUri, scopes, state, correlationId) {
        ...
        this.scopes = ScopeSet_ScopeSet.trimScopes(this.scopes);
    ...
    ServerRequestParameters.determineResponseType = function (accountsMatch, scopes) {
        ...
        if (ScopeSet_ScopeSet.onlyContainsOidcScopes(scopes)) {
    ...
    ServerRequestParameters.responseTypeForMatchingAccounts = function (scopes) {
        ...
        return (ScopeSet_ScopeSet.containsAnyOidcScopes(scopes)) ? ResponseTypes.id_token_token : ResponseTypes.token;
    };
 ...
 * @hidden
 */
var XHRClient_XhrClient = /** @class */ (function () {
    function XhrClient() {
    }
...
var TrustedAuthority_TrustedAuthority = /** @class */ (function () {
    ...
    TrustedAuthority.getAliases = function (authorityToVerify, telemetryManager, correlationId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                client = new XHRClient_XhrClient();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        host = UrlUtils_UrlUtils.GetUrlComponents(authorityToVerify).HostNameAndPort;
...
var Authority_Authority = /** @class */ (function () {
    ...
    Authority.prototype.DiscoverEndpoints = function (openIdConfigurationEndpoint, telemetryManager, correlationId) {
        var client = new XHRClient_XhrClient();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(TrustedAuthority_TrustedAuthority.getTrustedHostList().length === 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, TrustedAuthority_TrustedAuthority.setTrustedAuthoritiesFromNetwork(this.canonicalAuthority, telemetryManager, correlationId)];
                    case 1:
                        _b.sent();
                        _b.label = 2;
                    case 2:
                        if (!TrustedAuthority_TrustedAuthority.IsInTrustedHostList(host)) {
                            throw ClientConfigurationError_ClientConfigurationError.createUntrustedAuthorityError(host);
                        }
                        _b.label = 3;
                    case 3:
 ...
 * @hidden
 */
var BrowserStorage_BrowserStorage = /** @class */ (function () {
    function BrowserStorage(cacheLocation) {
        if (!window) {
            throw AuthError_AuthError.createNoWindowObjectError("Browser storage class could not find window object");
        }
        var storageSupported = typeof window[cacheLocation] !== "undefined" && window[cacheLocation] !== null;
        if (!storageSupported) {
            throw ClientConfigurationError_ClientConfigurationError.createStorageNotSupportedError(cacheLocation);
        }
 ...
 * @hidden
 */
var RequestUtils_RequestUtils = /** @class */ (function () {
    ...
    RequestUtils.validateRequest = function (request, isLoginCall, clientId, interactionType) {
        ...
        if (request) {
            ...
            scopes = isLoginCall ? ScopeSet_ScopeSet.appendScopes(request.scopes, request.extraScopesToConsent) : request.scopes;
            ScopeSet_ScopeSet.validateInputScope(scopes, !isLoginCall);
            scopes = ScopeSet_ScopeSet.translateClientIdIfSingleScope(scopes, clientId);
    ...
    RequestUtils.parseLibraryState = function (state) {
        ...
        try {
            ...
            throw ClientAuthError_ClientAuthError.createInvalidStateError(state, null);
        }
    };
    /**
     * @ignore
    ...
    RequestUtils.validateAndGenerateCorrelationId = function (correlationId) {
        ...
        if (correlationId && !CryptoUtils.isGuid(correlationId)) {
            throw ClientConfigurationError_ClientConfigurationError.createInvalidCorrelationIdError();
        }
 ...
 * @hidden
 */
var AuthCache_AuthCache = /** @class */ (function (_super) {
    ...
    function AuthCache(clientId, cacheLocation, storeAuthStateInCookie) {
        ...
        _this.temporaryCache = new BrowserStorage_BrowserStorage(SESSION_STORAGE);
    ...
    AuthCache.prototype.migrateCacheEntries = function (storeAuthStateInCookie) {
        ...
        if (idTokenValue) {
            try {
                idToken = new IdToken_IdToken(idTokenValue);
            }
            catch (e) {
                return;
            }
    ...
    AuthCache.prototype.resetTempCacheItems = function (state) {
        var _this = this;
        var stateId = state && RequestUtils_RequestUtils.parseLibraryState(state).id;
    ...
    AuthCache.prototype.setInteractionInProgress = function (newInProgressValue) {
        if (newInProgressValue) {
            if (this.isInteractionInProgress(false)) {
                throw ClientAuthError_ClientAuthError.createAcquireTokenInProgressError();
            }
            else {
    ...
    AuthCache.generateAcquireTokenAccountKey = function (accountId, state) {
        var stateId = RequestUtils_RequestUtils.parseLibraryState(state).id;
...
var WindowUtils_WindowUtils = /** @class */ (function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var intervalId = setInterval(function () {
                if (TimeUtils.relativeNowMs() > timeoutMark) {
                    ...
                    reject(ClientAuthError_ClientAuthError.createTokenRenewalTimeoutError());
                    return;
                }
                var href;
                try {
                ...
                if (href && UrlUtils_UrlUtils.urlContainsHash(href)) {
    ...
    WindowUtils.blockReloadInHiddenIframes = function () {
        ...
        if (UrlUtils_UrlUtils.urlContainsHash(window.location.hash) && WindowUtils.isInIframe()) {
            throw ClientAuthError_ClientAuthError.createBlockTokenRequestsInHiddenIframeError();
        }
    };
    /**
     *
    ...
    WindowUtils.checkIfBackButtonIsPressed = function (cacheStorage) {
        ...
        if (redirectCache && !UrlUtils_UrlUtils.urlContainsHash(window.location.hash)) {
...
var AuthorityFactory_AuthorityFactory = /** @class */ (function () {
        ...
        try {
            if (authorityMetadataJson) {
                ...
                if (!parsedMetadata.authorization_endpoint || !parsedMetadata.end_session_endpoint || !parsedMetadata.issuer) {
                    throw ClientConfigurationError_ClientConfigurationError.createInvalidAuthorityMetadataError();
                }
    ...
    AuthorityFactory.CreateInstance = function (authorityUrl, validateAuthority, authorityMetadata) {
        ...
        return new Authority_Authority(authorityUrl, validateAuthority, this.metadataMap.get(authorityUrl));
    };
...
var DEFAULT_AUTH_OPTIONS = {
    ...
    authorityMetadata: "",
    knownAuthorities: [],
    redirectUri: function () { return UrlUtils_UrlUtils.getCurrentUrl(); },
    postLogoutRedirectUri: function () { return UrlUtils_UrlUtils.getCurrentUrl(); },
...
var scrubTenantFromUri = function (uri) {
    ...
    if (Authority_Authority.isAdfs(uri)) {
        /**
...
var mapEventIdentiferToCode = (ApiEvent_a = {},
    ApiEvent_a[API_EVENT_IDENTIFIER.AcquireTokenSilent] = API_CODE.AcquireTokenSilent,
    ApiEvent_a[API_EVENT_IDENTIFIER.AcquireTokenPopup] = API_CODE.AcquireTokenPopup,
    ApiEvent_a[API_EVENT_IDENTIFIER.AcquireTokenRedirect] = API_CODE.AcquireTokenRedirect,
    ApiEvent_a[API_EVENT_IDENTIFIER.LoginPopup] = API_CODE.LoginPopup,
    ApiEvent_a[API_EVENT_IDENTIFIER.LoginRedirect] = API_CODE.LoginRedirect,
    ApiEvent_a[API_EVENT_IDENTIFIER.Logout] = API_CODE.Logout,
    ApiEvent_a);
var ApiEvent_ApiEvent = /** @class */ (function (_super) {
...
var HttpEvent_HttpEvent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(HttpEvent.prototype, "queryParams", {
        set: function (queryParams) {
            this.event[HttpEvent_EVENT_KEYS.QUERY_PARAMETERS] = ServerRequestParameters_ServerRequestParameters.generateQueryParametersString(queryParams);
        },
        enumerable: false,
        configurable: true
    });
 ...
 * @hidden
 */
var AuthCacheUtils_AuthCacheUtils = /** @class */ (function () {
    ...
    AuthCacheUtils.filterTokenCacheItemsByScope = function (tokenCacheItems, requestScopes) {
        return tokenCacheItems.filter(function (cacheItem) {
            ...
            var searchScopes = ScopeSet_ScopeSet.removeDefaultScopes(requestScopes);
            ...
            return searchScopes.length === 0 ? ScopeSet_ScopeSet.containsScope(cachedScopes, requestScopes) : ScopeSet_ScopeSet.containsScope(cachedScopes, searchScopes);
        });
    };
    AuthCacheUtils.filterTokenCacheItemsByAuthority = function (tokenCacheItems, authority) {
        return tokenCacheItems.filter(function (cacheItem) { return UrlUtils_UrlUtils.CanonicalizeUri(cacheItem.key.authority) === authority; });
    };
    AuthCacheUtils.filterTokenCacheItemsByDomain = function (tokenCacheItems, requestDomain) {
        return tokenCacheItems.filter(function (cacheItem) {
            var cacheItemDomain = UrlUtils_UrlUtils.GetUrlComponents(cacheItem.key.authority).HostNameAndPort;
...
var UserAgentApplication_UserAgentApplication = /** @class */ (function () {
    ...
    function UserAgentApplication(configuration) {
        ...
        TrustedAuthority_TrustedAuthority.setTrustedAuthoritiesFromConfig(this.config.auth.validateAuthority, this.config.auth.knownAuthorities);
        AuthorityFactory_AuthorityFactory.saveMetadataFromConfig(this.config.auth.authority, this.config.auth.authorityMetadata);
        // if no authority is passed, set the default: "https://login.microsoftonline.com/common"
        this.authority = this.config.auth.authority || UserAgentApplication_DEFAULT_AUTHORITY;
        // cache keys msal - typescript throws an error if any value other than "localStorage" or "sessionStorage" is passed
        this.cacheStorage = new AuthCache_AuthCache(this.clientId, this.config.cache.cacheLocation, this.inCookie);
        ...
        var urlContainsHash = UrlUtils_UrlUtils.urlContainsHash(urlHash);
        // check if back button is pressed
        WindowUtils_WindowUtils.checkIfBackButtonIsPressed(this.cacheStorage);
    ...
    UserAgentApplication.prototype.urlContainsHash = function (hash) {
        ...
        return UrlUtils_UrlUtils.urlContainsHash(hash);
    };
    ...
    UserAgentApplication.prototype.loginRedirect = function (userRequest) {
        ...
        // validate request
        var request = RequestUtils_RequestUtils.validateRequest(userRequest, true, this.clientId, Constants.interactionTypeRedirect);
    ...
    UserAgentApplication.prototype.acquireTokenRedirect = function (userRequest) {
        ...
        // validate request
        var request = RequestUtils_RequestUtils.validateRequest(userRequest, false, this.clientId, Constants.interactionTypeRedirect);
    ...
    UserAgentApplication.prototype.loginPopup = function (userRequest) {
        ...
        // validate request
        var request = RequestUtils_RequestUtils.validateRequest(userRequest, true, this.clientId, Constants.interactionTypePopup);
    ...
    UserAgentApplication.prototype.acquireTokenPopup = function (userRequest) {
        ...
        // validate request
        var request = RequestUtils_RequestUtils.validateRequest(userRequest, false, this.clientId, Constants.interactionTypePopup);
    ...
    UserAgentApplication.prototype.acquireTokenInteractive = function (interactionType, isLoginCall, request, resolve, reject) {
        ...
        WindowUtils_WindowUtils.blockReloadInHiddenIframes();
        try {
            this.cacheStorage.setInteractionInProgress(true);
        }
        catch (e) {
            // If already in progress, do not proceed
            var thrownError = isLoginCall ? ClientAuthError_ClientAuthError.createLoginInProgressError() : ClientAuthError_ClientAuthError.createAcquireTokenInProgressError();
        ...
        if (!account && !ServerRequestParameters_ServerRequestParameters.isSSOParam(request)) {
            ...
            // AcquireToken call, but no account or context given, so throw error
                ...
                var stateOnlyResponse = buildResponseStateOnly(this.getAccountState(request.state));
                this.cacheStorage.resetTempCacheItems(request.state);
                this.authErrorHandler(interactionType, ClientAuthError_ClientAuthError.createUserLoginRequiredError(), stateOnlyResponse, reject);
                return;
            }
        }
        // User session exists
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        acquireTokenAuthority = (request && request.authority) ? AuthorityFactory_AuthorityFactory.CreateInstance(request.authority, this.config.auth.validateAuthority, request.authorityMetadata) : this.authorityInstance;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 11, , 12]);
                        if (!!acquireTokenAuthority.hasCachedMetadata()) return [3 /*break*/, 3];
                        this.logger.verbose("No cached metadata for authority");
                        return [4 /*yield*/, AuthorityFactory_AuthorityFactory.saveMetadataFromNetwork(acquireTokenAuthority, this.telemetryManager, request.correlationId)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                    ...
                    case 4:
                        ...
                        serverAuthenticationRequest = new ServerRequestParameters_ServerRequestParameters(acquireTokenAuthority, this.clientId, responseType, this.getRedirectUri(request && request.redirectUri), request.scopes, request.state, request.correlationId);
                        ...
                        urlNavigate = UrlUtils_UrlUtils.createNavigateUrl(serverAuthenticationRequest) + Constants.response_mode_fragment;
                        // set state in cache
                        if (interactionType === Constants.interactionTypeRedirect) {
                            if (!isLoginCall) {
                                this.cacheStorage.setItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.STATE_ACQ_TOKEN, request.state), serverAuthenticationRequest.state, this.inCookie);
                        ...
                        try {
                            ...
                            WindowUtils_WindowUtils.trackPopup(popUpWindow);
                        }
                        catch (e) {
                    ...
                    case 5:
                        _a.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, WindowUtils_WindowUtils.monitorPopupForHash(popUpWindow, this.config.system.loadFrameTimeout, urlNavigate, this.logger)];
                    case 6:
                        hash = _a.sent();
                        ...
                        WindowUtils_WindowUtils.closePopups();
                        return [3 /*break*/, 8];
                    case 7:
                        error_1 = _a.sent();
                        if (reject) {
                    ...
                    case 11:
                        ...
                        this.cacheStorage.resetTempCacheItems(request.state);
                        this.authErrorHandler(interactionType, ClientAuthError_ClientAuthError.createEndpointResolutionError(err_1.toString), buildResponseStateOnly(request.state), reject);
                        if (popUpWindow) {
                            popUpWindow.close();
                        }
                        return [3 /*break*/, 12];
    ...
    UserAgentApplication.prototype.ssoSilent = function (request) {
        ...
        if (!request.sid && !request.loginHint) {
            throw ClientConfigurationError_ClientConfigurationError.createSsoSilentError();
        }
    ...
    UserAgentApplication.prototype.acquireTokenSilent = function (userRequest) {
        ...
        var request = RequestUtils_RequestUtils.validateRequest(userRequest, false, this.clientId, Constants.interactionTypeSilent);
        var apiEvent = this.telemetryManager.createAndStartApiEvent(request.correlationId, API_EVENT_IDENTIFIER.AcquireTokenSilent);
        var requestSignature = RequestUtils_RequestUtils.createRequestSignature(request);
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        // if user didn't pass login_hint/sid and adal's idtoken is present, extract the login_hint from the adalIdToken
                            ...
                            adalIdTokenObject = TokenUtils_TokenUtils.extractIdToken(adalIdToken);
                    ...
                    case 2:
                        ...
                        if (!serverAuthenticationRequest.authorityInstance) {
                            serverAuthenticationRequest.authorityInstance = request.authority ?
                                AuthorityFactory_AuthorityFactory.CreateInstance(request.authority, this.config.auth.validateAuthority, request.authorityMetadata)
                    ...
                    case 3:
                        ...
                        this.logger.verbose("No cached metadata for authority");
                        return [4 /*yield*/, AuthorityFactory_AuthorityFactory.saveMetadataFromNetwork(serverAuthenticationRequest.authorityInstance, this.telemetryManager, request.correlationId)];
                    case 4:
                        _a.sent();
                    ...
                    case 6:
                        ...
                        if (window.activeRenewals[requestSignature]) {
                            ...
                            if (request.scopes && ScopeSet_ScopeSet.onlyContainsOidcScopes(request.scopes)) {
                                /*
                    ...
                    case 7:
                        ...
                        reject(ClientAuthError_ClientAuthError.createEndpointResolutionError(err_2.toString()));
                        return [2 /*return*/, null];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.cacheStorage.setItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.RENEW_STATUS, expectedState), Constants.inProgress);
                        if (!this.config.system.navigateFrameWait) return [3 /*break*/, 2];
                        return [4 /*yield*/, WindowUtils_WindowUtils.loadFrame(urlNavigate, frameName, this.config.system.navigateFrameWait, this.logger)];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        _a = WindowUtils_WindowUtils.loadFrameSync(urlNavigate, frameName, this.logger);
                        _b.label = 3;
                    case 3:
                        iframe = _a;
                        _b.label = 4;
                    case 4:
                        _b.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, WindowUtils_WindowUtils.monitorIframeForHash(iframe.contentWindow, this.config.system.loadFrameTimeout, urlNavigate, this.logger)];
                    case 5:
                        hash = _b.sent();
                        if (hash) {
                            this.handleAuthenticationResponse(hash);
                    ...
                    case 6:
                        error_2 = _b.sent();
                        if (this.cacheStorage.getItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.RENEW_STATUS, expectedState)) === Constants.inProgress) {
                            ...
                            this.cacheStorage.removeItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.RENEW_STATUS, expectedState));
                        }
                        WindowUtils_WindowUtils.removeHiddenIframe(iframe);
                        throw error_2;
                    case 7:
                        WindowUtils_WindowUtils.removeHiddenIframe(iframe);
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.logger.verbose("No cached metadata for authority");
                        return [4 /*yield*/, AuthorityFactory_AuthorityFactory.saveMetadataFromNetwork(this.authorityInstance, this.telemetryManager, correlationId)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    UserAgentApplication.prototype.handleRedirectAuthenticationResponse = function (hash) {
        ...
        WindowUtils_WindowUtils.clearUrlFragment(window);
        ...
        if (this.config.auth.navigateToLoginRequestUrl && window.parent === window) {
            ...
            var loginRequestUrl = this.cacheStorage.getItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.LOGIN_REQUEST, stateInfo.state), this.inCookie);
            ...
            if (!loginRequestUrl || loginRequestUrl === "null") {
                ...
                var currentUrl = UrlUtils_UrlUtils.removeHashFromUrl(window.location.href);
                var finalRedirectUrl = UrlUtils_UrlUtils.removeHashFromUrl(loginRequestUrl);
                if (currentUrl !== finalRedirectUrl) {
                    ...
                    var loginRequestUrlComponents = UrlUtils_UrlUtils.GetUrlComponents(loginRequestUrl);
    ...
    UserAgentApplication.prototype.getResponseState = function (hash) {
        ...
        var parameters = UrlUtils_UrlUtils.deserializeHash(hash);
        var stateResponse;
        if (!parameters) {
        ...
        if (parameters.hasOwnProperty(ServerHashParamKeys.STATE)) {
            ...
            var parsedState = RequestUtils_RequestUtils.parseLibraryState(parameters["state"]);
            stateResponse = {
         ...
         */
        // loginRedirect
        if (stateResponse.state === this.cacheStorage.getItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.STATE_LOGIN, stateResponse.state), this.inCookie) || stateResponse.state === this.silentAuthenticationState) {
        ...
        else if (stateResponse.state === this.cacheStorage.getItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.STATE_ACQ_TOKEN, stateResponse.state), this.inCookie)) {
    ...
    UserAgentApplication.prototype.getCachedToken = function (serverAuthenticationRequest, account) {
        ...
        return ResponseUtils_ResponseUtils.buildAuthResponse(idToken, authResponse, serverAuthenticationRequest, account, scopes, accountState);
    };
    /**
     * @hidden
     *
    ...
    UserAgentApplication.prototype.getTokenCacheItemByAuthority = function (authority, tokenCacheItems, requestScopes, tokenType) {
        ...
        if (UrlUtils_UrlUtils.isCommonAuthority(authority) || UrlUtils_UrlUtils.isOrganizationsAuthority(authority) || UrlUtils_UrlUtils.isConsumersAuthority(authority)) {
            filteredAuthorityItems = AuthCacheUtils_AuthCacheUtils.filterTokenCacheItemsByDomain(tokenCacheItems, UrlUtils_UrlUtils.GetUrlComponents(authority).HostNameAndPort);
        }
        else {
            filteredAuthorityItems = AuthCacheUtils_AuthCacheUtils.filterTokenCacheItemsByAuthority(tokenCacheItems, authority);
        }
    ...
    UserAgentApplication.prototype.getCachedIdToken = function (serverAuthenticationRequest, account) {
        ...
        if (idTokenCacheItem) {
            ...
            if (idTokenIsStillValid) {
                ...
                return (idTokenValue) ? new IdToken_IdToken(idTokenValue.idToken) : null;
            }
            else {
    ...
    UserAgentApplication.prototype.getCachedAccessToken = function (serverAuthenticationRequest, account, scopes) {
        ...
        var scopeFilteredTokenCacheItems = AuthCacheUtils_AuthCacheUtils.filterTokenCacheItemsByScope(tokenCacheItems, scopes);
        var matchAuthority = serverAuthenticationRequest.authority || this.authority;
    ...
    UserAgentApplication.prototype.evaluateTokenExpiration = function (tokenCacheItem) {
        ...
        return TokenUtils_TokenUtils.validateExpirationIsWithinOffset(expiration, this.config.system.tokenRenewalOffsetSeconds);
    };
    /**
     * @hidden
    ...
    UserAgentApplication.prototype.extractADALIdToken = function () {
        ...
        return (!StringUtils.isEmpty(adalIdToken)) ? TokenUtils_TokenUtils.extractIdToken(adalIdToken) : null;
    };
    /**
     * @hidden
    ...
    UserAgentApplication.prototype.renewToken = function (requestSignature, resolve, reject, account, serverAuthenticationRequest) {
        ...
        var frameName = WindowUtils_WindowUtils.generateFrameName(FramePrefix.TOKEN_FRAME, requestSignature);
        WindowUtils_WindowUtils.addHiddenIFrame(frameName, this.logger);
        this.updateCacheEntries(serverAuthenticationRequest, account, false);
        this.logger.verbosePii("RenewToken expected state: " + serverAuthenticationRequest.state);
        // Build urlNavigate with "prompt=none" and navigate to URL in hidden iFrame
        var urlNavigate = UrlUtils_UrlUtils.urlRemoveQueryStringParameter(UrlUtils_UrlUtils.createNavigateUrl(serverAuthenticationRequest), Constants.prompt) + Constants.prompt_none + Constants.response_mode_fragment;
        window.renewStates.push(serverAuthenticationRequest.state);
    ...
    UserAgentApplication.prototype.renewIdToken = function (requestSignature, resolve, reject, account, serverAuthenticationRequest) {
        ...
        var frameName = WindowUtils_WindowUtils.generateFrameName(FramePrefix.ID_TOKEN_FRAME, requestSignature);
        WindowUtils_WindowUtils.addHiddenIFrame(frameName, this.logger);
        this.updateCacheEntries(serverAuthenticationRequest, account, false);
    ...
    UserAgentApplication.prototype.saveToken = function (response, authority, scopes, clientInfo, expiration) {
        var accessTokenKey = new AccessTokenKey_AccessTokenKey(authority, this.clientId, scopes, clientInfo.uid, clientInfo.utid);
    ...
    UserAgentApplication.prototype.saveAccessToken = function (response, authority, parameters, clientInfo) {
        ...
        for (var i = 0; i < accessTokenCacheItems.length; i++) {
            ...
            if (accessTokenCacheItem.key.homeAccountIdentifier === response.account.homeAccountIdentifier) {
                ...
                if (ScopeSet_ScopeSet.isIntersectingScopes(cachedScopes, consentedScopes)) {
                    this.cacheStorage.removeItem(JSON.stringify(accessTokenCacheItem.key));
                }
            }
        }
        ...
        var parsedState = RequestUtils_RequestUtils.parseLibraryState(parameters[ServerHashParamKeys.STATE]);
    ...
    UserAgentApplication.prototype.saveTokenFromHash = function (hash, stateInfo) {
        ...
        var error;
        var hashParams = UrlUtils_UrlUtils.deserializeHash(hash);
        var authorityKey = "";
        ...
        if (hashParams.hasOwnProperty(ServerHashParamKeys.ERROR_DESCRIPTION) || hashParams.hasOwnProperty(ServerHashParamKeys.ERROR)) {
            ...
            if (stateInfo.requestType === Constants.login) {
                ...
                authorityKey = AuthCache_AuthCache.generateAuthorityKey(stateInfo.state);
            }
            // acquireToken
            if (stateInfo.requestType === Constants.renewToken) {
                ...
                acquireTokenAccountKey = AuthCache_AuthCache.generateAcquireTokenAccountKey(accountId, stateInfo.state);
            }
            ...
            if (InteractionRequiredAuthError_InteractionRequiredAuthError.isInteractionRequiredError(hashErr) ||
                ...
                error = new InteractionRequiredAuthError_InteractionRequiredAuthError(hashParams[ServerHashParamKeys.ERROR], hashParams[ServerHashParamKeys.ERROR_DESCRIPTION]);
            }
            else {
                error = new ServerError_ServerError(hashParams[ServerHashParamKeys.ERROR], hashParams[ServerHashParamKeys.ERROR_DESCRIPTION]);
            }
        }
        // If the server returns "Success"
            ...
            if (stateInfo.stateMatch) {
                ...
                if (hashParams.hasOwnProperty(ServerHashParamKeys.SESSION_STATE)) {
                    ...
                    this.cacheStorage.setItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.SESSION_STATE, stateInfo.state), hashParams[ServerHashParamKeys.SESSION_STATE]);
                }
                ...
                if (hashParams.hasOwnProperty(ServerHashParamKeys.ACCESS_TOKEN)) {
                    ...
                    if (hashParams.hasOwnProperty(ServerHashParamKeys.ID_TOKEN)) {
                        ...
                        idTokenObj = new IdToken_IdToken(hashParams[ServerHashParamKeys.ID_TOKEN]);
                    }
                    else {
                        this.logger.verbose("No idToken on fragment, getting idToken from cache");
                        idTokenObj = new IdToken_IdToken(this.cacheStorage.getItem(PersistentCacheKeys.IDTOKEN));
                    }
                    ...
                    if (hashParams.hasOwnProperty(ServerHashParamKeys.CLIENT_INFO)) {
                        ...
                        clientInfo = new ClientInfo_ClientInfo(hashParams[ServerHashParamKeys.CLIENT_INFO], authority);
                    }
                    else if (this.authorityInstance.AuthorityType === AuthorityType.Adfs) {
                        clientInfo = ClientInfo_ClientInfo.createClientInfoFromIdToken(idTokenObj, authority);
                    }
                    else {
                        this.logger.warning("ClientInfo not received in the response from AAD");
                    }
                    response.account = Account_Account.createAccount(idTokenObj, clientInfo);
                    ...
                    acquireTokenAccountKey = AuthCache_AuthCache.generateAcquireTokenAccountKey(accountKey, stateInfo.state);
                    var acquireTokenAccountKey_noaccount = AuthCache_AuthCache.generateAcquireTokenAccountKey(Constants.no_account, stateInfo.state);
                ...
                if (hashParams.hasOwnProperty(ServerHashParamKeys.ID_TOKEN)) {
                    ...
                    this.account = Account_Account.createAccount(idTokenObj, clientInfo);
                    response.account = this.account;
                    this.logger.verbose("Account object created from response");
                    if (idTokenObj && idTokenObj.nonce) {
                        this.logger.verbose("IdToken has nonce");
                        // check nonce integrity if idToken has nonce - throw an error if not matched
                        var cachedNonce = this.cacheStorage.getItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.NONCE_IDTOKEN, stateInfo.state), this.inCookie);
                        if (idTokenObj.nonce !== cachedNonce) {
                            ...
                            error = ClientAuthError_ClientAuthError.createNonceMismatchError(cachedNonce, idTokenObj.nonce);
                        }
                        // Save the token
                        else {
            ...
            // State mismatch - unexpected/invalid state
                ...
                authorityKey = stateInfo.state;
                acquireTokenAccountKey = stateInfo.state;
                var expectedState = this.cacheStorage.getItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.STATE_LOGIN, stateInfo.state), this.inCookie);
        ...
        this.cacheStorage.removeItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.RENEW_STATUS, stateInfo.state));
        this.cacheStorage.resetTempCacheItems(stateInfo.state);
    ...
    UserAgentApplication.prototype.populateAuthority = function (state, inCookie, cacheStorage, idTokenObj) {
        ...
        var authorityKey = AuthCache_AuthCache.generateAuthorityKey(state);
        var cachedAuthority = cacheStorage.getItem(authorityKey, inCookie);
        // retrieve the authority from cache and replace with tenantID
        return StringUtils.isEmpty(cachedAuthority) ? cachedAuthority : UrlUtils_UrlUtils.replaceTenantPath(cachedAuthority, idTokenObj.tenantId);
    };
    /* tslint:enable:no-string-literal */
    // #endregion
    // #region Account
    ...
    UserAgentApplication.prototype.getCachedTokenInternal = function (scopes, account, state, correlationId) {
        ...
        var serverAuthenticationRequest = new ServerRequestParameters_ServerRequestParameters(newAuthority, this.clientId, responseType, this.getRedirectUri(), scopes, state, correlationId);
        // get cached token
    ...
    UserAgentApplication.prototype.getScopesForEndpoint = function (endpoint) {
        ...
        if (endpoint.indexOf("http://") > -1 || endpoint.indexOf("https://") > -1) {
            if (UrlUtils_UrlUtils.getHostFromUri(endpoint) === UrlUtils_UrlUtils.getHostFromUri(this.getRedirectUri())) {
    ...
    UserAgentApplication.prototype.getTokenType = function (accountObject, scopes) {
        var accountsMatch = Account_Account.compareAccounts(accountObject, this.getAccount());
        return ServerRequestParameters_ServerRequestParameters.determineResponseType(accountsMatch, scopes);
    };
    /**
     * @hidden
     * @ignore
    ...
    UserAgentApplication.prototype.setAccountCache = function (account, state) {
        ...
        var acquireTokenAccountKey = AuthCache_AuthCache.generateAcquireTokenAccountKey(accountId, state);
    ...
    UserAgentApplication.prototype.updateCacheEntries = function (serverAuthenticationRequest, account, isLoginCall, loginStartPage) {
        ...
        if (loginStartPage) {
            this.cacheStorage.setItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.LOGIN_REQUEST, serverAuthenticationRequest.state), loginStartPage, this.inCookie);
        }
        // Cache account and authority
        if (isLoginCall) {
            // Cache the state
            this.cacheStorage.setItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.STATE_LOGIN, serverAuthenticationRequest.state), serverAuthenticationRequest.state, this.inCookie);
        }
        else {
        ...
        // Cache nonce
        this.cacheStorage.setItem(AuthCache_AuthCache.generateTemporaryCacheKey(TemporaryCacheKeys.NONCE_IDTOKEN, serverAuthenticationRequest.state), serverAuthenticationRequest.nonce, this.inCookie);
    };
    /**
...
function MSAL(config, authParams = { scopes: ["https://graph.microsoft.com/.default"] }) {
    const app = new UserAgentApplication_UserAgentApplication(config);
    return (instance) => {
