...
export const deleteSiteProperty = (values: any, extPath: string) => {
  return moduleLoader(extPath).then((modules) => {
    ...
    const sitePropertyPayload = (pkey: any, pvalue: any, psiteId: any, pdel: boolean) => {
      return `
            ...
            <ObjectPaths>
              ...
              <Property Id="4" ParentId="2" Name="Sites" />
    ...
    return pnpsp
      .spPost(pnpsp.Web(sp.web, `/_vti_bin/client.svc/ProcessQuery`), {
        body: sitePropertyPayload(values.key, '', values.siteId, true),
      })
      .then((r) => {
        ...
        return sp.web.lists
          ...
          .then((res: any) => {
            ...
            if (vtiprop && vtiprop.indexOf(b64encoded) > -1) {
              ...
              return pnpsp
                .spPost(pnpsp.Web(sp.web, `/_vti_bin/client.svc/ProcessQuery`), {
                  body: sitePropertyPayload('vti_indexedpropertykeys', newIndexValue, values.siteId, false),
                })
                .then((r2) => {
